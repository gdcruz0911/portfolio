...
export function NowPlaying() {
  ...
  return <div className="pond-speaker">
    ...
    <p className="listening-note signature" aria-hidden>what&rsquo;s he listening to right now?
      <svg viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M4 30 C 14 27, 24 18, 29 7 M21 10 l8 -4 l2 9" /></svg>
    </p>
